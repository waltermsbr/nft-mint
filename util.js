async function init() {
	if (window.ethereum == null) {
		...
		contract = new ethers.Contract('0x6C62cF140E5E301B635708165198Dee80Ef54931', abi, provider);
		...
		network = await provider.getNetwork();
		contract = new ethers.Contract('0x6C62cF140E5E301B635708165198Dee80Ef54931', abi, signer);
		console.log('selected provider: ', provider);
		console.log('network:', network);
		...
		try {
			const autorizado = await contract.hasRole(
